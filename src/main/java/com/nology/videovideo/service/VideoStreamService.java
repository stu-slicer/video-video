package com.nology.videovideo.service;

import com.nology.videovideo.service.bytereader.ByteReader;
import com.nology.videovideo.service.bytereader.CachingRandomAccessByteReader;
...
import static com.nology.videovideo.constants.ApplicationConstants.*;
...
public class VideoStreamService {
    ...
    @Autowired
    private ByteReader byteReader = new CachingRandomAccessByteReader();
        ...
        try {
            ...
            if (range == null) {
                return ResponseEntity.status(HttpStatus.PARTIAL_CONTENT)
                        ...
                        .body(byteReader.readByteRange(fileKey, rangeStart, rangeEnd)); // Read the object and convert it as bytes
            }
            ...
            final byte[] data = byteReader.readByteRange(fileKey, rangeStart, rangeEnd);
    ...
    private String getFilePath() {
        ...
        assert url != null;
        return new File("D:\\_Development\\intellij\\workspace-nology\\video-video\\films").getAbsolutePath();
    }
